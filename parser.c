...
void statement() {
    ...
    switch (token->type) {
        ...
        case T_K_IF:
            ...
            token_ptr prec_token = expression(&expression_list_if, 1);
        ...
        case T_K_WHILE:
            ...
            token_ptr prec_token1 = expression(&expression_list_if, 1);
...
void entry_param(functionPtrData functionData) {
    if ((token->type == T_ID) && (token->next->type != T_EQL) &&
        ...
        token_ptr prec_token = expression(&expression_list, 0);
